...
from Web_Application_Data_Collection_Prototype.data_processing import Collection_Data_Process, Practise_Data_Process
...
@app.route('/practise/')
def practise_page():
    return render_template('/practise_page/Practise_Page.html')


# Collection page renderer
@app.route('/collection/')
def collection_page():
    return render_template('/collection_page/Collection_Page.html')
...
def practise_record_start_audio_1():
    ...
    return render_template('/practise_page/Practise_Page_Recording1_Done.html')
...
def practise_record_audio_2():
    fluency_type = request.form['speech_category']
    Practise_Data_Process.process_data(fluency_type)
    return render_template('/practise_page/Practise_Page_Recording2_Done.html')
...
def collection_start_record_audio_1():
    ...
    return render_template('/collection_page/Collection_Page_Recording1_Done.html')
...
def collection_start_record_audio_2():
    fluency_type = request.form['speech_category']
    Collection_Data_Process.process_data(fluency_type)
    return render_template('/collection_page/Collection_Page_Recording2_Done.html')
...
def collection_start_record_audio_3():
    fluency_type = request.form['speech_category']
    Collection_Data_Process.process_data(fluency_type)
    return render_template('/collection_page/Collection_Page_Recording3_Done.html')
